var onRun = function(context) {
    ...
    var barNum = 120;
    var color_rise = "#6DC8EA";
    var color_fall = "#6DC8EA";
    ...
    function drawGraphK(size){
        ...
        for(var i=0; i<barNum; i++){
            ...
            if(cAry[i] - oAry[i]>=0){
                newColor = color_rise;
                var bar = drawBox(Math.round(newBX), Math.round(newBY), barWidth, Math.round(newBH), newColor, graph);
            }else{
                newColor = color_fall;
                var bar = drawBox(Math.round(newBX), Math.round(newBY), barWidth, Math.round(newBH), newColor, graph);
            }
    ...
    */
    ...
    //========== Draw a Rect ==========
    function drawBox(x, y, width, height, bgColor, parent, radius) {
        radius = radius || 0;
